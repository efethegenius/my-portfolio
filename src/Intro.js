        ...
        <Fade bottom cascade>
          <div className="about-me">
            ...
            <p id="p1">
              ...
              such as Javascript Es6+, React.js, HTML5 and CSS3 while
              consistently recieving high user experience score for all my web
            ...
            <Fade bottom cascade>
              <h1>“You’re a techy Nerd...” you might say...</h1>
              <p>
                Well, I have a Bsc in Computer Science + a burning passion and
                talent in all things computer softwares, what do you expect?
              </p>
            </Fade>
          </div>
        </Fade>
